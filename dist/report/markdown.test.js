...
test("markdownReportFilename uses view suffixes", () => {
    assert.equal(markdownReportFilename(SAMPLE_REPORT, "billable"), "sanity-request-log-report_billable-only.md");
    assert.equal(markdownReportFilename(SAMPLE_REPORT, "all"), "sanity-request-log-report_all.md");
});
