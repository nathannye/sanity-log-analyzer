...
import { hasImageFormatError, hasImageQualityError, hasImageWidthError, parseImageUrl, toInlineAssetUrl, } from "./parse-image-url.js";
describe("parseImageUrl", () => {
    it("extracts id and width from the filename suffix", () => {
        const parsed = parseImageUrl("https://cdn.sanity.io/images/project/dataset/photo-400x300.jpg");
    ...
    it("prefers the w query param over filename dimensions", () => {
        const parsed = parseImageUrl("https://cdn.sanity.io/images/project/dataset/photo-400x300.jpg?w=1200");
        assert.equal(parsed.width, 1200);
    });
    it("reads quality and format query params", () => {
        const parsed = parseImageUrl("https://cdn.sanity.io/images/project/dataset/photo-400x300.jpg?q=90&fm=webp");
        assert.equal(parsed.quality, 90);
        assert.equal(parsed.format, "webp");
    });
    it("detects svg assets", () => {
        const parsed = parseImageUrl("https://cdn.sanity.io/images/project/dataset/logo-120x40.svg");
...
describe("toInlineAssetUrl", () => {
    it("removes the Sanity CDN dl download param", () => {
        assert.equal(toInlineAssetUrl("https://cdn.sanity.io/images/p/d/a.jpg?w=100&dl=null&q=71"), "https://cdn.sanity.io/images/p/d/a.jpg?w=100&q=71");
    });
...
//# sourceMappingURL=parse-image-url.test.js.map