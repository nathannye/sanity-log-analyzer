...
var ms = /* @__PURE__ */ c((/* @__PURE__ */ o(((e, t) => {
	var n = function(e) {
...
typeof Prism < "u" && typeof Prism.languages == "object" && Prism.languages !== null && !Array.isArray(Prism.languages) && (Prism.languages.groq = hs), Object.assign((e) => {
	e.languages.groq = hs;
}, {
	displayName: "groq",
	aliases: []
...
function gs(e) {
	return ms.default.highlight(e, ms.default.languages.groq, "groq");
}
//#endregion
...
function ys({ stats: e }) {
	let t = _s.filter((t) => e[t] > 0).sort((t, n) => e[n] - e[t]), n = Object.entries(e.functionCalls).filter(([, e]) => e > 0).sort(([e], [t]) => e.localeCompare(t));
...
function bs({ id: e, query: t, params: n = null, requests: r, responseBytes: i }) {
	let a = ps(t), o = gs(a), s = Pn(a, n ?? void 0), c = Fn(a, n ?? void 0), l = r > 0 ? i / r : 0, u = n && Object.keys(n).length > 0 ? JSON.stringify(n, null, 2) : null;
			...
			children: [
				...
				/* @__PURE__ */ $("div", {
					...
					children: [/* @__PURE__ */ $("div", {
						class: "eyebrow-1 mb-8 text-muted",
						children: "Structure"
					}), s ? /* @__PURE__ */ $(ys, { stats: s }) : /* @__PURE__ */ $("p", {
...
function Ss({ content: e, children: t, placement: n = "top", class: r }) {
	let i = n === "bottom" ? xs.placementBottom : xs.placementTop;
...
function ws({ rows: e, showFlyout: t = !1, variant: n = "default", idPrefix: r }) {
						...
						i && d ? /* @__PURE__ */ $(ae, { children: [
							/* @__PURE__ */ $("td", {
								...
								children: /* @__PURE__ */ $("div", {
									...
									children: [/* @__PURE__ */ $("span", { children: Cs(d.width) }), nr(d.width) ? /* @__PURE__ */ $(Ss, {
							...
							/* @__PURE__ */ $("td", {
								...
								children: /* @__PURE__ */ $("div", {
									class: "inline-flex items-center gap-6",
									children: [/* @__PURE__ */ $("span", { children: Cs(d.quality) }), rr(d.quality, d.isSvg) ? /* @__PURE__ */ $(Ss, {
							...
							/* @__PURE__ */ $("td", { children: /* @__PURE__ */ $("div", {
								class: "inline-flex items-center gap-6",
								children: [/* @__PURE__ */ $("span", { children: Cs(d.format) }), ir(d.format) ? /* @__PURE__ */ $(Ss, {
		...
		children: [/* @__PURE__ */ $("div", {
			...
			children: [
				t.deviceKind ? /* @__PURE__ */ $("span", {
					...
					children: t.deviceKind === "mobile" ? /* @__PURE__ */ $(Os, {}) : /* @__PURE__ */ $(Ds, {})
				}) : null,
				/* @__PURE__ */ $("span", {
...
function js({ title: e, rows: t }) {
	return /* @__PURE__ */ $(Zo, {
		title: e,
		rows: t,
		header: /* @__PURE__ */ $(As, { rows: t }),
		renderLabel: (e) => /* @__PURE__ */ $(ks, { raw: e.label })
	});
}
//#endregion
