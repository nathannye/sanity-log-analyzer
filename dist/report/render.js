...
function qe({ data: e }) {
	return /* @__PURE__ */ Y("header", {
		...
		children: [/* @__PURE__ */ Y("div", { children: [/* @__PURE__ */ Y("h1", {
			...
			children: [/* @__PURE__ */ Y("div", { children: ["Generated on: ", We(e.generatedAt)] }), /* @__PURE__ */ Y("div", { children: ["Max table rows: ", e.config.topN] })]
		})]
	});
}
//#endregion
...
function X({ variant: e = "default", icon: t, iconPosition: n = "start", children: r, class: i, type: a = "button", ...o }) {
	return /* @__PURE__ */ Y("button", {
		type: a,
		class: [Je[e], i].filter(Boolean).join(" "),
		...o,
		children: [
...
function dt(e) {
	let t = st(e);
	if (!t) return null;
	if (lt(t)) return "query";
	let n = t.toLowerCase();
	if (n.includes("/images/")) return "image";
	let r = ct(t);
	return it.has(r) ? "image" : at.has(r) ? "video" : n.includes("/files/") || ot.has(r) ? "file" : null;
}
//#endregion
...
function pt(e) {
	return ft.filter((t) => t.id !== "other" || e.other.length > 0);
}
function mt(e) {
	let t = {
		image: [],
...
function yt(e, t) {
	return vt.filter((t) => !t.configKey || e[t.configKey]).map(({ slug: e, label: n }) => ({
		slug: e,
		label: n,
		children: e === "urls" ? _t(t) : void 0
	}));
}
//#endregion
//#region src/report/components/TableOfContents.tsx
function bt({ sections: e, urlRows: t }) {
	let n = yt(e, t);
...
function kt({ title: e, rows: t, accent: n, emptyMessage: r, axisMax: i, formatAxisTick: a }) {
	let o = Et(i);
				...
				children: /* @__PURE__ */ Y("div", {
					...
					children: [o.map((e) => /* @__PURE__ */ Y("div", {
						...
						children: t.map((e) => {
							...
							return /* @__PURE__ */ Y("div", {
								class: `${Ot.barColumn} relative flex min-h-0 min-w-16 flex-1 flex-col items-stretch`,
								"data-tip": e.tip,
								children: [/* @__PURE__ */ Y("div", {
									class: "flex min-h-0 flex-1 items-end",
									children: /* @__PURE__ */ Y("div", {
										class: `${Ot.bar} w-full min-h-2 rounded-t-sm`,
										style: {
											height: `${t.toFixed(2)}%`,
											background: n
										}
...
function Pt({ title: e, rows: t, accent: n }) {
	return /* @__PURE__ */ Y(kt, {
		title: e,
		accent: n,
		emptyMessage: "No bandwidth data in this range.",
		axisMax: Dt(t.reduce((e, t) => Math.max(e, t.responseBytes), 0), Mt(.001)),
		formatAxisTick: Nt,
		rows: t.map((e) => ({
			label: e.label,
			value: e.responseBytes,
			tip: `${q(e.responseBytes)} · ${K(e.requests)} requests`
		}))
	});
}
//#endregion
//#region src/report/components/BarList.tsx
function Ft({ title: e, rows: t, accent: n }) {
...
function Lt({ title: e, rows: t, accent: n }) {
	return /* @__PURE__ */ Y(kt, {
		...
		axisMax: Dt(t.reduce((e, t) => Math.max(e, t.count), 0)),
		formatAxisTick: It,
		rows: t.map((e) => ({
			label: e.label,
			value: e.count,
...
function Rt({ title: e, rows: t, accent: n }) {
...
function Bt({ title: e, rows: t, hasCopyButton: n = !1, copyToastMessage: r = "Copied", labelAdornment: i, renderLabel: a, header: o }) {
	return /* @__PURE__ */ Y("section", {
		class: "card",
		children: [
			/* @__PURE__ */ Y("h3", {
...
var Ut = { donut: "_donut_1drq4_1" };
//#endregion
//#region src/report/components/Donut.tsx
function Wt({ slices: e }) {
	return /* @__PURE__ */ Y("div", {
		class: "body-1 grid w-full gap-10 text-muted",
		children: e.map((e) => /* @__PURE__ */ Y("div", { children: [
			/* @__PURE__ */ Y("span", {
...
function Gt({ slices: e, centerLabel: t, centerNote: n, embedded: r = !1 }) {
	return /* @__PURE__ */ Y("div", {
		class: r ? "grid justify-items-center gap-16" : "mt-12 grid justify-items-center gap-16",
		children: [/* @__PURE__ */ Y("div", {
			class: `${Ut.donut} relative grid aspect-square w-full max-w-[24rem] place-items-center rounded-full p-22`,
			style: Ht(e),
			children: /* @__PURE__ */ Y("div", {
		...
		}), /* @__PURE__ */ Y(Wt, { slices: e })]
	});
}
function Kt({ title: e, slices: t, primary: n, secondary: r, colors: i, centerNote: a, embedded: o = !1 }) {
	if (t && t.length > 0) {
		let n = t.reduce((e, t) => e + t.value, 0), r = /* @__PURE__ */ Y(Gt, {
			slices: t.map((e) => ({
				...e,
	...
	let s = n.value + r.value, c = s > 0 ? n.value / s * 100 : 0, l = [{
		...
		children: [/* @__PURE__ */ Y("div", {
			class: `${Ut.donut} relative grid aspect-square w-full place-items-center rounded-full p-22`,
			style: Vt(n.value, r.value, i.primary, i.secondary),
			children: /* @__PURE__ */ Y("div", {
				class: "body-1 relative z-1 grid justify-items-center gap-4 text-center",
				children: [/* @__PURE__ */ Y("strong", {
					class: "heading-4",
					children: q(s)
				}), /* @__PURE__ */ Y("span", { children: J(c) })]
			})
		}), /* @__PURE__ */ Y(Wt, { slices: l })]
	});
	return o ? u : /* @__PURE__ */ Y("article", {
		class: "card",
		children: [/* @__PURE__ */ Y("h3", {
			class: "heading-3",
			children: e
...
function Yt({ minor: e, minorTotals: t }) {
			...
			children: [/* @__PURE__ */ Y("summary", {
				...
				children: [
					...
					/* @__PURE__ */ Y("span", {
						...
						children: q(t.responseBytes)
					}),
					/* @__PURE__ */ Y("span", {
						class: "num shrink-0 text-text",
						children: K(t.requests)
					})
				]
			}), /* @__PURE__ */ Y("div", {
				...
				children: /* @__PURE__ */ Y("table", {
					class: "body-1 data-table",
					children: /* @__PURE__ */ Y("tbody", { children: e.map((e) => /* @__PURE__ */ Y("tr", { children: [
						/* @__PURE__ */ Y("td", {
...
function Xt({ title: e, rows: t }) {
	let { major: n, minor: r, minorTotals: i } = Jt(t);
	return /* @__PURE__ */ Y("div", {
		class: "card",
		children: [/* @__PURE__ */ Y("h3", {
			class: "heading-3",
			...
			children: [/* @__PURE__ */ Y("div", {
				...
				children: n.length > 0 ? /* @__PURE__ */ Y(Kt, {
					embedded: !0,
					title: "",
					...
					centerNote: `${n.length} endpoint${n.length === 1 ? "" : "s"} > 5%`
				}) : /* @__PURE__ */ Y("div", {
					class: "body-1 card mt-0 text-muted",
					children: "No endpoints reach 5% of endpoint bandwidth in this view."
				})
			}), r.length > 0 ? /* @__PURE__ */ Y(Yt, {
				minor: r,
				minorTotals: i
			}) : null]
		})]
...
function $t(e) {
	let t = Zt(e), n = t ? e.slice(0, -t.length) : e, r = n.split("-"), i = (r[r.length - 1] ?? "").match(/^(\d+)x(\d+)$/);
	return i ? {
...
function en(e) {
	try {
		let t = new URL(e), n = t.pathname.split("/").filter(Boolean).at(-1) ?? e, r = Zt(n) === ".svg", { id: i, width: a } = $t(n);
		return {
			id: i,
			width: Qt(t.searchParams.get("w")) ?? a,
			quality: Qt(t.searchParams.get("q")),
...
function on(e, t) {
	return t === "image" ? en(e.label).id : e.label;
}
function sn({ title: e, contributor: t, labelKind: n = "default", showRequests: r = !0 }) {
	let i = on(t, n);
	return /* @__PURE__ */ Y("article", {
		...
		children: [
			...
			r ? /* @__PURE__ */ Y("div", {
				...
				children: [K(t.requests), " requests"]
			}) : null
		]
	});
}
...
function cn({ totalBytes: e, segments: t }) {
	return /* @__PURE__ */ Y("article", {
		...
		children: [
			...
			/* @__PURE__ */ Y("div", {
				...
				children: t.map((e) => /* @__PURE__ */ Y("div", { children: [
					He(e.share),
					" ",
					e.label
				] }, e.label))
...
function un({ text: e, tone: t }) {
	...
	return t && n.push(ln[t]), /* @__PURE__ */ Y("article", {
		class: n.join(" "),
...
function dn({ title: e, items: t, emptyMessage: n, tone: r }) {
	return t.length === 0 && !n ? null : /* @__PURE__ */ Y("div", {
		class: "flex flex-col gap-12",
		children: [/* @__PURE__ */ Y("div", {
			class: "eyebrow-1 section-title",
			children: e
		}), t.length === 0 ? /* @__PURE__ */ Y(un, {
			text: n ?? "",
			tone: r
		}) : /* @__PURE__ */ Y("div", {
			class: "flex flex-col gap-12",
			children: t.map((e) => /* @__PURE__ */ Y(un, {
				text: e,
				tone: r
			}, e))
		})]
...
function fn({ summary: e }) {
	...
	return /* @__PURE__ */ Y("section", {
		...
		children: [
			e.atAGlance.length > 0 ? /* @__PURE__ */ Y("div", {
				...
				children: [
					...
					t.length > 0 ? /* @__PURE__ */ Y("div", {
						...
						children: t.map((e) => /* @__PURE__ */ Y(un, { text: e.text }, e.text))
					}) : null,
					n ? /* @__PURE__ */ Y("p", {
...
function _n(e) {
	...
	try {
		let t = new URL(e);
		return hn(t.hostname) || mn(t.hostname, t.port);
	} catch {
		return gn(e);
	}
}
...
function bn({ title: e, rows: t }) {
	return /* @__PURE__ */ Y(Bt, {
		title: e,
		rows: t,
		renderLabel: (e) => /* @__PURE__ */ Y(yn, { row: e })
	});
}
//#endregion
//#region src/report/groq-constants.ts
var xn = "uses the {...} spread operator and may waste bandwidth by fetching more fields than needed", Sn = [
	"dereferences",
	"projections",
	"subqueries",
	"spreads",
...
function wn({ stats: e }) {
	let t = Sn.filter((t) => e[t] > 0).sort((t, n) => e[n] - e[t]), n = Object.entries(e.functionCalls).filter(([, e]) => e > 0).sort(([e], [t]) => e.localeCompare(t));
...
function Tn({ id: e, details: t, requests: n, responseBytes: r }) {
			...
			children: [
				...
				/* @__PURE__ */ Y("div", {
					...
					children: [/* @__PURE__ */ Y("div", {
						class: "eyebrow-1 mb-8 text-muted",
						children: "Structure"
					}), o ? /* @__PURE__ */ Y(wn, { stats: o }) : /* @__PURE__ */ Y("p", {
...
function Dn({ content: e, children: t, placement: n = "top", class: r }) {
	let i = n === "bottom" ? En.placementBottom : En.placementTop;
...
function kn({ rows: e, showFlyout: t = !1, groqByUrl: n = {}, variant: r = "default", idPrefix: i }) {
	...
	return /* @__PURE__ */ Y("div", {
		...
		children: /* @__PURE__ */ Y("table", {
			...
			] }) }), /* @__PURE__ */ Y("tbody", { children: e.map((e, r) => {
				let c = t ? n[e.label] : void 0, l = c ? `${i}-flyout-${r}` : void 0, u = a ? en(e.label) : null;
				return /* @__PURE__ */ Y("tr", {
					"data-row-index": r,
					"data-sort-label": Q(a ? u?.id ?? e.label : e.label),
					"data-sort-bandwidth": Q(e.responseBytes),
					"data-sort-requests": Q(e.requests),
					"data-sort-avg": Q(zt(e)),
					...a ? {
					...
					children: [
							...
							children: [/* @__PURE__ */ Y("div", {
								...
								children: [
									...
									s ? /* @__PURE__ */ Y("a", {
										...
										rel: "noopener noreferrer",
										class: "btn-ghost-sm",
										"aria-label": `Open "${a ? u?.id ?? e.label : e.label}" in new tab`,
										title: "Open in new tab",
										children: /* @__PURE__ */ Y("span", {
											class: "btn-icon",
											children: /* @__PURE__ */ Y(Xe, {})
									...
									/* @__PURE__ */ Y("span", {
										class: "min-w-0 flex-1 truncate",
										children: a ? u?.id : e.label
									}),
									o && ut(e.label) ? /* @__PURE__ */ Y(Dn, {
									...
									c?.hasSpreadOperator ? /* @__PURE__ */ Y(Dn, {
										content: `This query ${xn}.`,
										children: /* @__PURE__ */ Y("span", {
											class: "inline-flex shrink-0 text-[var(--color-amber,#f59e0b)] [&>svg]:size-14",
											children: /* @__PURE__ */ Y(Ze, {})
										})
						...
						a && u ? /* @__PURE__ */ Y(S, { children: [
							/* @__PURE__ */ Y("td", {
								class: "num",
								children: /* @__PURE__ */ Y("div", {
									class: "inline-flex items-center gap-6",
									children: [/* @__PURE__ */ Y("span", { children: On(u.width) }), nn(u.width) ? /* @__PURE__ */ Y(Dn, {
							...
							/* @__PURE__ */ Y("td", {
								...
								children: /* @__PURE__ */ Y("div", {
									class: "inline-flex items-center gap-6",
									children: [/* @__PURE__ */ Y("span", { children: On(u.quality) }), rn(u.quality, u.isSvg) ? /* @__PURE__ */ Y(Dn, {
							...
							/* @__PURE__ */ Y("td", { children: /* @__PURE__ */ Y("div", {
								class: "inline-flex items-center gap-6",
								children: [/* @__PURE__ */ Y("span", { children: On(u.format) }), an(u.format) ? /* @__PURE__ */ Y(Dn, {
...
function An({ rows: e, groqByUrl: t, idPrefix: n }) {
	let r = mt(e), i = ht(r), a = pt(r);
	return /* @__PURE__ */ Y("section", {
		...
		children: [/* @__PURE__ */ Y("div", {
			...
			children: [
				t.deviceKind ? /* @__PURE__ */ Y("span", {
					...
					children: t.deviceKind === "mobile" ? /* @__PURE__ */ Y(Nn, {}) : /* @__PURE__ */ Y(Mn, {})
				}) : null,
				/* @__PURE__ */ Y("span", {
					class: "min-w-0 truncate",
					children: t.deviceKind ? t.displayLabel : t.raw || t.displayLabel
				}),
				jn(e) ? /* @__PURE__ */ Y("span", {
					class: "badge-blue",
...
function Fn({ stats: e }) {
	return e.trackableRequests === 0 ? null : /* @__PURE__ */ Y("div", {
...
function In({ title: e, rows: t, userAgentByLabel: n, userAgentStats: r }) {
	return /* @__PURE__ */ Y(Bt, {
		title: e,
		rows: t,
		header: /* @__PURE__ */ Y(Fn, { stats: r }),
		renderLabel: (e) => /* @__PURE__ */ Y(Pn, {
			raw: e.label,
			parsed: n[e.label]
		})
	});
...
function Ln({ view: e, sections: t, viewKey: n, hidden: r = !1 }) {
	let i = e.firstTimestamp && e.lastTimestamp ? `${We(e.firstTimestamp)} → ${We(e.lastTimestamp)}` : "No timestamps found", a = e.summary;
	return /* @__PURE__ */ Y("div", {
		"data-report-view": n,
		hidden: r || void 0,
		children: [
			/* @__PURE__ */ Y(fn, { summary: a }),
			/* @__PURE__ */ Y("section", {
				class: "scroll-mt-20",
			...
			/* @__PURE__ */ Y("div", {
				...
				children: [/* @__PURE__ */ Y("div", {
					...
					children: [
						...
						t.endpoint ? /* @__PURE__ */ Y("section", {
							class: "scroll-mt-20",
							"data-section": "endpoint",
							children: /* @__PURE__ */ Y(Xt, {
								title: "Top endpoints",
								rows: e.byEndpoint
							})
						}) : null,
...
function Rn({ data: e }) {
	let t = Ct(), n = e.config.sections.billableComparison, r = n ? e.billable.byUrl : e.all.byUrl;
	return /* @__PURE__ */ Y("main", {
		class: "mx-auto max-w-1600 px-20 pb-56 pt-32",
		style: t,
		children: [/* @__PURE__ */ Y(qe, { data: e }), /* @__PURE__ */ Y("div", {
			...
			children: [/* @__PURE__ */ Y(bt, {
				...
				class: "min-w-0",
				children: [
					/* @__PURE__ */ Y(rt, { showToggle: n }),
					n ? /* @__PURE__ */ Y(S, { children: [/* @__PURE__ */ Y(Ln, {
						view: e.billable,
						sections: e.config.sections,
						viewKey: "billable"
					}), /* @__PURE__ */ Y(Ln, {
...
function Jn(e) {
	let t = ze(/* @__PURE__ */ Y(Rn, { data: e })), n = Ve(e), r = Ve({
		filenameBase: Ge(e.title),
