...
//#endregion
//#region src/report/components/MetricCard.tsx
var ts = {
	green: "tone-green",
	red: "tone-red",
	yellow: "tone-yellow"
};
function ns({ eyebrow: e, value: t, note: n, tone: r }) {
	let i = [
		"card",
		"card-metric",
		"flex",
	...
	return r && i.push(ts[r]), /* @__PURE__ */ $("article", {
		class: i.join(" "),
		children: /* @__PURE__ */ $("div", {
...
function is({ summary: e }) {
	return e.issueCounts.critical + e.issueCounts.warning, /* @__PURE__ */ $("section", {
		...
		children: [/* @__PURE__ */ $("div", {
			...
			children: [
				/* @__PURE__ */ $(ns, {
					tone: "red",
					eyebrow: "Critical",
					value: A(e.issueCounts.critical),
					note: "High-impact findings"
				}),
				/* @__PURE__ */ $(ns, {
					tone: "yellow",
					eyebrow: "Warnings",
					value: A(e.issueCounts.warning),
					note: "Worth reviewing"
				}),
				/* @__PURE__ */ $(ns, {
					tone: "green",
					eyebrow: "Passed",
					value: A(e.issueCounts.passed),
					note: "Healthy signals"
				}),
				e.estimatedSavingsBytes === void 0 ? null : /* @__PURE__ */ $(ns, {
					eyebrow: "Est. savings",
					value: j(e.estimatedSavingsBytes),
