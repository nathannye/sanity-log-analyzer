...
import { finishProgressLine, formatProgressMessage, getSpinnerFrame, prefixProgressLine, setProgressMessage, SPINNER_FRAMES, startProgressSpinner, } from "./progress-line.js";
...
test("prefixProgressLine formats frame and message", () => {
    assert.equal(prefixProgressLine("⠧", "Processed 1 KB / 2 KB (50.0%) — 1 entries"), "⠧ Processed 1 KB / 2 KB (50.0%) — 1 entries");
});
